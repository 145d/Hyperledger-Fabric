...
#
# 是否具有与bootstrap.sh完全相同的功能

### 由Argbash v2.9.0生成的代码开始 ###
# Argbash是一个bash代码生成器，用于正确解析参数
# Argbash是免费软件 see https://argbash.io for more info
# 在线生成 by https://argbash.io/generate

# Default values
_positionals=()
_arg_comp=('' )

# 如果没有传递版本，则默认为最新发布的版本
# 如果没有输入ca版本，则默认为最新发布的版本
...
# 首先处理示例，然后处理二进制文件。所以如果fabric-samples目录存在，二进制文件就会放到那里
